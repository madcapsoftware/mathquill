...
var manageTextarea = (function() {
  ...
  return function manageTextarea(el, opts) {
    ...
    target.bind('keydown keypress input keyup focusout cut paste', function() { checkTextarea(); })
    //TODO: Bind the target input the mathcanvas so that the input can be translated and placed into mathcanvas for translation.
